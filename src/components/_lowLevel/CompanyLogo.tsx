...
export const CompanyLogo = ({ height, style }) => {
  return (
        ...
        <svg
          ...
          class="logo" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        	 viewBox="0 0 388 115.2">
        ...
        <g id="HMH">
        	...
        	<path class="st4" d="M267.2,44.7c0-3.1,3-5,9.8-6.4v-0.5c0-3.3-1-4.6-3.4-4.6c-0.9,0-1.9,0.2-2.6,0.7c-0.1,0.2-0.2,0.4,0.1,0.5c1,0.5,1.4,1.7,0.9,2.6c-0.4,0.7-1.1,1.1-1.9,1.1c-1.1,0-2.1-0.9-2.1-2c0-0.1,0-0.2,0-0.3c0-2.4,2.6-4.2,6.2-4.2s6,1.9,6,5.9v7.8
